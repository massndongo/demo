...
public class UtilisateurController {
    ...
    public List<Utilisateur> getUserByFirstname(@PathVariable String firstname) {
        List<Utilisateur> utilisateur = userService.findByFirstName(firstname);
        if (utilisateur.isEmpty()) {
            return new ResponseEntity List() {
                
            };<Utilisateur>(HttpStatus.NO_CONTENT);
        } else {
            return new ResponseEntity<Utilisateur>(utilisateur, HttpStatus.OK);
        }
    }
